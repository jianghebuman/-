...
<style scoped lang="scss">.header{display:flex;justify-content:space-between;align-items:center;h2{margin-bottom:6px;}p{color:var(--cr-text-muted);}}.fav-card{background:#fff;border:1px solid var(--cr-border-soft);border-radius:8px;padding:18px;margin-bottom:16px;transition:.2s;&:hover{box-shadow:0 4px 14px rgba(0,0,0,.08)}}.job-title{font-weight:600;color:var(--cr-text);margin-bottom:8px}.salary{color:var(--cr-danger);font-size:18px;font-weight:600;margin-bottom:8px}.meta{color:var(--cr-text-muted);font-size:13px}.footer{display:flex;justify-content:space-between;align-items:center;margin-top:14px;color:var(--cr-text-muted);font-size:12px}</style>
